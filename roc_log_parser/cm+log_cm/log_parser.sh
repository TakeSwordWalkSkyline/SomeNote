...
sed -i 's/.*flush ID:\([0-9]\+\) start:\([0-9]\+\) end:\([0-9]\+\) t:\([0-9]\+\) cm:\(.*\) log-cm:\(.*\) rst:.*/\[check\] \1 \2 \5 \6/g' "${jn_check_file}"
...
sed -i 's/.*flush ID:\([0-9]\+\) start:\([0-9]\+\) end:\([0-9]\+\) t:\([0-9]\+\) cm:\(.*\) log-cm:\(.*\) rst:.*/\[check\] \1 \2 \5 \6/g' "${jw_check_file}"
